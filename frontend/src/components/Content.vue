    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            :src="require('../assets/img/pool4.jpg')"
            class="w-100"
            alt="Image"
          />
          <div
        ...
        <div class="carousel-item">
          <img
            :src="require('../assets/img/eagleview.jpg')"
            class="w-100"
            alt="Image"
          />
          <div
      ...
      <div class="modal-content rounded-0">
        ...
        <div class="modal-body">
          ...
          <video controls width="100%" height="auto">
            ...
            <source
              src="'../assets/img/bestresortinmindoro.mp4'"
              type="video/mp4"
            />
      ...
      <div class="row g-4">
        <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <a class="service-item rounded" href="">
            ...
            <p class="text-body mb-0">
              "Welcome to our luxurious and comfortable Rooms & Apartments at
              Eduardo's Resort. Our carefully designed accommodations are the
              perfect haven for relaxation and rejuvenation. From spacious rooms
              with breathtaking views to well-appointed apartments that feel
              like a home away from home, we offer a range of options to suit
              your every need. "
            </p>
          </a>
        </div>
        <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
          <a class="service-item rounded" href="">
            ...
            <p class="text-body mb-0">
              "Indulge in a culinary journey at our resort's Food & Restaurant,
              where exceptional flavors and exquisite dining experiences await
              you. Our expert chefs artfully prepare a diverse range of dishes
              that tantalize your taste buds, from delectable international
              cuisine to locally inspired delicacies. "
            </p>
          </a>
        </div>
      </div>
      ...
      <div class="row g-4">
        <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          <a class="service-item rounded" href="">
            ...
            <p class="text-body mb-0">
              "Dive into a world of aqua adventures at our resort's Swimming
              Lessons! Whether you're a beginner looking to conquer the waters
              or an experienced swimmer seeking to refine your skills, our
              certified instructors are here to guide you through an exciting
        ...
        <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <a class="service-item rounded" href="">
            ...
            <p class="text-body mb-0">
              "Experience unforgettable moments at our resort's Events and Party
              offerings. Whether you're celebrating a special occasion, hosting
              a corporate event, or simply looking for a place to unwind with
              friends and family, our resort provides the perfect backdrop for
              your gatherings. "
            </p>
          </a>
        </div>
